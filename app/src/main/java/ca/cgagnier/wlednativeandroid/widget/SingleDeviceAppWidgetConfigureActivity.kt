...
import ca.cgagnier.wlednativeandroid.databinding.SingleDeviceAppWidgetConfigureBinding
...
class SingleDeviceAppWidgetConfigureActivity : Activity() {
    ...
    private lateinit var binding: SingleDeviceAppWidgetConfigureBinding
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        binding = SingleDeviceAppWidgetConfigureBinding.inflate(layoutInflater)
        ...
        appWidgetText.setText(
            loadTitlePref(
                this@SingleDeviceAppWidgetConfigureActivity,
                appWidgetId
            )
        )
    }
